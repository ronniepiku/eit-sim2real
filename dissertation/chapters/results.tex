...
These analyses should be interpreted as exploratory diagnostics rather than primary benchmark estimates, since they do not yet use the full multi-seed protocol applied to the main condition matrix and ablation tables.

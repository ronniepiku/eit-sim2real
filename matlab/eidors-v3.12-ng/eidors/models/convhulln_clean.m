...
% $Id: convhulln_clean.m 6580 2023-04-10 14:36:44Z aadler $
...
% Octave <=7.3 gives massive text output
% from Qhull. Instead go straight to joggle
% version
% However, Octave 8.1 seems fine.

% TODO: should we always use joggle anyway?
try

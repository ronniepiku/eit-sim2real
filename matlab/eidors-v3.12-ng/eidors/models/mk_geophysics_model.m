...
SALT='z$Id: mk_geophysics_model.m 6926 2024-05-31 15:34:13Z bgrychtol $'; % stick a key in the model 'save' file, so we can expire them when the model definitions age
